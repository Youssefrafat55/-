...
setInterval(() => {
  http.get(`http://js-music1-new.glitch.me/`);
}, 280000);
...
const youtube = new YouTube('AIzaSyAZewBKWY9wk-5UMCBubc4Ue7C1LfNj5A8');
...
let g = client.guilds.get("608318367656312864"); // id server
let c = g.channels.get("608318367656312876");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
